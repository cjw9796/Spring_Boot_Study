...
// 1.네이버 개발자 센터 회원가입
// 2. 어플리케이션 등록 
// Client ID : jN5Ym07IaQ9vBFMJRp42 
// Client Secret : ouJuE3moAB  
...
public class ApiExamSearchBlog {
	...
	public static void main(String[] args) {
		String clientId = "jN5Ym07IaQ9vBFMJRp42"; // 애플리케이션 클라이언트 아이디
		String clientSecret = "ouJuE3moAB"; // 애플리케이션 클라이언트 시크릿
