...
public class MainController {
	...
	// 단순요청
	@RequestMapping("/thymeleaf-test") //http://localhost:9080/thymeleaf-test
	public String thymeleafTest() {
		return "thymeleaf-test"; 
	}

	// 단순요청
	@RequestMapping("/thymeleaf-test2") //http://localhost:9080/thymeleaf-test2
	public String thymeleafTest2() {
		return "thymeleaf-test2"; // thymeleaf-test2.html
	}

	// 단순요청 + 뷰페이지로 데이터(Model) 전달하기
	@RequestMapping("/thymeleaf-test3") //http://localhost:9080/thymeleaf-test3
	...
	// 단순요청 + 뷰페이지로 데이터(Model) 전달하기
	@RequestMapping("/thymeleaf-test4") //http://localhost:9080/thymeleaf-test4
	public ModelAndView thymeleafTest4(ModelAndView mav) {
		...
		mav.setViewName("thymeleaf-test4"); // thymeleaf-test4.html
		
		return mav; // thymeleaf-test4.html
	}

	// 단순요청 + 뷰페이지로 데이터(Model) 전달하기
		@RequestMapping("/thymeleaf-test5/{num}")  //http://localhost:9080/thymeleaf-test5/50
		public String thymeleafTest5(@PathVariable int num,Model model) {
			...
			return "thymeleaf-test5"; //// thymeleaf-test5.html
		}
		...
		@RequestMapping(value="/thymeleaf-test6",method=RequestMethod.GET) //http://localhost:9080/thymeleaf-test6
		...
		public ModelAndView formSend(@RequestParam("data1") String data1,				
			...
			// mav.addObject("msg", "회원님 입력값" + <span style='color:red'> + data1 + </span> + "입니다." );
		...
		@RequestMapping(value="/thymeleaf-test7",method=RequestMethod.GET) //http://localhost:9080/thymeleaf-test7
